...
public:
	...
	int depth_ = 0; // the depth of object
	int dim_ = 0; // the dim of object

	float pX_; // the x-coordinate of the point
	float pY_; // the y - coordinate of the point

	float lineXmin_;  //the min x - coordinate of the line point1
	float lineXmax_;  //the max x - coordinate of the line point1
	float lineYmin_;  //the min y - coordinate of the line point2
